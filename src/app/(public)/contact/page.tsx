...
export const metadata = {
  title: "联系我们 - Colorful Card",
  description: "联系深圳市彩卡科技有限公司，获取智能卡和RFID解决方案",
};
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 md:py-16">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-1">地址</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@colorfulcard.com</p>
                  </div>
                </div>
            ...
            {/* 联系表单 */}
            <div>
              <h2 className="text-2xl font-bold mb-6">发送询盘</h2>
      ...
      <section className="py-12 md:py-16 bg-muted/30">
        <div className="container">
          ...
          <div className="aspect-video bg-muted rounded-lg w-full"></div>
        </div>
      </section>
    </div>
  );
